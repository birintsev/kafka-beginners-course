package tutorial2.highthroughput;
...
public class TwitterProducer {
    ...
    public static final List<String> TERMS = Lists.newArrayList(
        "bitcoin",
        "kafka",
        "java",
        "usa",
    ...
    private KafkaProducer<String, String> createKafkaProducer() {
        ...
        properties.setProperty(ProducerConfig.MAX_IN_FLIGHT_REQUESTS_PER_CONNECTION, String.valueOf(5)); // for kafka >= 1.1 we may keep it equal to 5. use 1 otherwise.
